...
<body>
  <h2>
    <?php
    $str = 'Appleが5個あります。Orangeには1個しかありません。';
  ...
  <p>
   ...
   <p>
    <?php
    echo '1回以上繰り返されている(1文字以上の英数字が含まれているかどうかを正規表現で検索し、検索結果を配列に代入します。<br>)';
   ...
   <p>
    <?php
    echo '改行以外の1回以上繰り返されている(1文字の)文字が含まれているかどうかを正規表現で検索し、検索結果を配列に代入します。<br>';
  ...
  <p>
    <?php
    echo 'メールアドレスのフォーマットとして完全に一致しているかどうかを正規表現で検索します。<br>';
